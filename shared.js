...
(function () {
  ...
  if (window.location.search.indexOf('sent=1') !== -1) {
    ...
    toast.innerHTML = '<span class="form-toast-icon">✓</span>' + (isDE ? 'Ihre Nachricht wurde gesendet. Wir melden uns bald.' : 'Your message has been sent. We\'ll be in touch soon.');
    document.body.appendChild(toast);
    setTimeout(function () { toast.classList.add('on'); }, 80);
    setTimeout(function () { toast.classList.remove('on'); }, 5500);
